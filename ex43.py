...
class Combat(object):
    ...
    def combat(self, hero, monster):
        ...
        while True:
            ...
            # action of monster, 2/5 possibility it will defends
...
"""
Study Drill:
2. After the heor enters the scene, the resulted next scene would be returned as next_scene_name and line 18 load the scene from next_scene_name using a corresponding scene in a dict with scene name.
"""